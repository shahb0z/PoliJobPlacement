...
public class LoginActivity1 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionButton2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity1.this,SignupActivity1.class));
            }
        });
    }
    ...
    private void login() {
        ...
        if (validationError) {
            Toast.makeText(LoginActivity1.this, validationErrorMessage.toString(), Toast.LENGTH_LONG)
                    .show();
            return;
        }
        ...
        ParseUser.logInInBackground(username, password, new LogInCallback() {
            ...
            public void done(ParseUser user, ParseException e) {
                ...
                if (e != null) {
                    ...
                    Toast.makeText(LoginActivity1.this, e.getMessage(), Toast.LENGTH_LONG).show();
                } else {
